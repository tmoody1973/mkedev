...
- **SECTION_NAME** = [Human-readable name, e.g., "Conversational Interface" or "Geospatial Explorer"]
- **SECTION_ID** = [Folder name in sections/, e.g., "conversational-interface" or "geospatial-explorer"]

...
import { Camera, Sparkles, X, MapPin, Clock, Trash2 } from 'lucide-react';
...
export function VisualizationGallery() {
  ...
  const hasContent = screenshots.length > 0 || visualizations.length > 0;
    ...
    <div className="h-full flex flex-col overflow-hidden bg-stone-50 dark:bg-stone-900">
      ...
      <div className="p-6 border-b-2 border-stone-200 dark:border-stone-700">
        ...
        <p className="text-stone-600 dark:text-stone-400 mt-1">
          {visualizations.length} visualizations, {screenshots.length} screenshots
        </p>
      </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-bold text-stone-900 dark:text-stone-100">
                AI Visualizations ({visualizations.length})
              </h3>
            </div>

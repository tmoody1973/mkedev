...
> = {
  zoning: {
    type: 'fill',
    paint: {
      // Granular zone-specific colors - can customize any zone code
      'fill-color': [
        'match',
        ['get', 'Zoning'],
        // Single-Family Residential (light greens)
        'RS1', '#90EE90', // Light green
        'RS2', '#7CCD7C',
        'RS3', '#6BBF6B',
        'RS4', '#5AB05A',
        'RS5', '#4AA04A',
    ...
    minzoom: 10,
    maxzoom: 22, // Allow overzooming beyond tile maxzoom (16)
  },
  parcels: {
    type: 'fill',
    paint: {
    ...
    maxzoom: 22, // Allow overzooming beyond tile maxzoom
  },
  tif: {
    type: 'fill',
    paint: {

...
import { Map, Box, History, Sparkles } from 'lucide-react'
import { UserMenu } from '@/components/user-menu'
import { AddressSearchBox } from './AddressSearchBox'
import { LayersDropdown } from './LayersDropdown'
import { VoiceButton, useVoice } from '@/components/voice'

export interface HeaderProps {
  /** @deprecated Use useVoice hook instead - Whether voice mode is active */
  isVoiceActive?: boolean
  /** @deprecated Use useVoice hook instead - Callback when voice toggle is clicked */
  onVoiceToggle?: () => void
...
export function Header({
  ...
  // Use the voice context for Gemini Live integration
  const { session, toggleSession } = useVoice()
  return (
    <header
    ...
    >
      ...
      <div className="flex items-center gap-2">
        {/* Voice Toggle - Gemini Live Integration */}
        <VoiceButton
          state={session.state}

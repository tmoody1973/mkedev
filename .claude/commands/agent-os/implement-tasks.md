...
### PHASE 2.5: Auto-log to devlog (after each task group)

After each task group is completed, append an entry to `devlog.md`:

```markdown
## [DATE] - Task Completion

### Completed
- [x] [Task Group Name] (spec: [spec-name])

### Implementation Notes
- [Brief summary of what was built]
- [Any key decisions or deviations]

---
```

This ensures progress is tracked automatically without manual intervention.

...
- [ ] 1.0 Complete monorepo setup with pnpm workspaces
  ...
  - [ ] 1.5 Configure shared ESLint and Prettier configs
  ...
  - [ ] 1.6 Create `.env.local.example` with all required variables
...
- [ ] 2.0 Complete design system setup
  - [ ] 2.1 Configure Tailwind CSS with design tokens
  ...
  - [ ] 2.2 Initialize shadcn CLI and install RetroUI base
...
- [ ] 3.0 Complete Convex backend initialization
  - [ ] 3.1 Initialize Convex in apps/web
    - Run `npx convex dev` to create project
    - Configure Convex provider in app layout
  - [ ] 3.2 Define `parcels` table schema
  ...
  - [ ] 3.3 Define `zoningDistricts` table schema
    ...
    - Include createdAt/updatedAt timestamps
  - [ ] 3.4 Define `incentiveZones` table schema
    ...
    - Include createdAt/updatedAt timestamps
  - [ ] 3.5 Define `areaPlans` table schema
    ...
    - Include createdAt/updatedAt timestamps
  - [ ] 3.6 Define `conversations` table schema
    - Fields: userId, title, starred (boolean)
    - Include createdAt/updatedAt timestamps
    - Index on userId for user queries
  - [ ] 3.7 Define `messages` table schema
  ...
  - [ ] 3.8 Define `documents` table schema
...
- [ ] 4.0 Complete Clerk authentication setup
...
- [ ] 6.0 Complete ESRI layer integration
  - [ ] 6.1 Integrate Zoning Districts layer (Layer 11)
...
- [ ] 7.0 Complete layer controls UI
  - [ ] 7.1 Create LayerPanel component structure
...
- [ ] 8.0 Complete application shell
  - [ ] 8.1 Create AppShell layout component
  ...
  - [ ] 8.2 Implement mobile responsive layout
  ...
  - [ ] 8.4 Integrate providers in app layout
  ...
  - [ ] 8.5 Write 2-4 focused tests for app shell
...
- [ ] 9.0 Complete chat panel UI
  - [ ] 9.1 Create ChatPanel container component
...
- [ ] 11.0 Complete document ingestion infrastructure
  - [ ] 11.1 Configure Firecrawl API connection
...
- [ ] 12.0 Verify complete foundation integration
  - [ ] 12.1 Review all tests from previous task groups
  ...
  - [ ] 12.2 Identify critical integration gaps
  ...
  - [ ] 12.3 Write up to 10 additional integration tests if needed
  ...
  - [ ] 12.4 Run all foundation-specific tests
  ...
  - [ ] 12.5 Verify development environment completeness
